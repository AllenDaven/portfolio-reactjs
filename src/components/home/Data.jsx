...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Portfolio portfolio = new Portfolio();</h3>

            <h1 className="home__title">Allen Daven Argallon
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Transforming ideas into elegant and efficient web experiences.</p>
